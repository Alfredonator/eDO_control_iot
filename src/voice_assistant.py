        ...
        while attempt < 3:
            ...
            if 'start' in command:
                ...
                action_publisher = subprocess.Popen(
                    ["/bin/bash", "rostopic", "pub", "-r", "20", "/robot_operation", "std_msgs/String", "start"],
                ...
                if action_publisher:
                    action_publisher.kill()
                action_publisher = subprocess.Popen(
                    ["/bin/bash", "rostopic", "pub", "-r", "20", "/robot_operation", "std_msgs/String", "stop"],
                    env={'ROS_MASTER_URI': 'http://10.42.0.49:11311\''})
                break
                ...
                velocity_publisher = subprocess.Popen(
                    ["/bin/bash", "rostopic", "pub", "-r", "20", "/robot_velocity", "std_msgs/String", f'"{numbers}"'],
                    env={'ROS_MASTER_URI': 'http://10.42.0.49:11311\''})
                break
